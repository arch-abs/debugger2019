...
<body>
	<header style="height: 50px; background-color: rgba(32, 169, 112, 0.14); text-align: center;">
		<div class="left" id="teamheader" style="float:left; margin-left: 20px; margin-top: 15px; color:white;">Hi <?php echo $_SESSION['teamName']; ?></div>
				...
				if ($_SESSION ['language'] == 1 || $_SESSION ['language'] == 2) {
					if ($_SESSION ['stage'] == '0'||$_SESSION ['stage'] == '1a' || $_SESSION ['stage'] == '1b') {
						...
						echo '
							...
							<li>You will be given 5 questions with syntax errors <strong>only.</strong></li>
							...
							<li>Note:<strong>The SUBMIT button will submit the corresponding question.</strong></li>
						...
						echo '
							<ul id="Rules">
							<li>The second round will be of 45 minutes.</li>
						...
						echo '
							...
							<li>You will be given 3 questions with <strong>all</strong> kinds of humanly-possible error.</li>
							<li>You are required to debug the code using <strong>minimum</strong> number of changes.</li>
							<li><strong>You are not allowed to leave the interface at any time of the contest.</strong></li>
							<li>Note:<strong>The SUBMIT button will submit the corresponding question.</strong></li>
							<li>Any act of dishonesty will result in immediate disqualification.</li>

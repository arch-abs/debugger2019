...
//				echo $i,'<br>';
    ...
    <button id="resetAnswer" onclick="ResetAns('question.php', '<?php echo $_SESSION['stage']; ?>')" class="button btn btn-large btn-danger" style="position: absolute; right: 1%; bottom: 5%; width: 200px;">Reset Answer
    </button>
